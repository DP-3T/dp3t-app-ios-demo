...
class NSOnboardingViewController: NSViewController {
    ...
    private let step2VC = NSOnboardingStepViewController(model: NSOnboardingStepModel(heading: "onboarding_top_label_how".ub_localized, foregroundImage: UIImage(named: "onboarding-2")!, title: "onboarding_title_2".ub_localized, text: "onboarding_desc_2".ub_localized))
    private let step3VC = NSOnboardingStepViewController(model: NSOnboardingStepModel(heading: "onboarding_top_label_how".ub_localized, foregroundImage: UIImage(named: "onboarding-3")!, title: "onboarding_title_3".ub_localized, text: "onboarding_desc_3".ub_localized))
